...
namespace FilmReview.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmID,FilmImageLink,FilmName,Tags,Country,Duration,MPAA,Year,Summ,Total,About")] Films films)
        {
                _context.Add(films);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmID,FilmImageLink,FilmName,Tags,Country,Duration,MPAA,Year,Summ,Total,About")] Films films)
        {
            if (id != films.FilmID)
            {
                return NotFound();
